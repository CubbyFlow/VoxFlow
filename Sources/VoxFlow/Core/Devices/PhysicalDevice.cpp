...
PhysicalDevice::PhysicalDevice(Instance* instance)
{
    ...
    vkEnumeratePhysicalDevices(instance->get(), &numPhysicalDevices, deviceCandidates.data());
...
std::vector<VkLayerProperties> PhysicalDevice::getPossibleLayers() const
{
    ...
    vkEnumerateDeviceLayerProperties(_physicalDevice, &layerCount, layerProperties.data());
...
std::vector<VkQueueFamilyProperties> PhysicalDevice::getQueueFamilyProperties() const
{
    ...
    vkGetPhysicalDeviceQueueFamilyProperties(_physicalDevice, &familyCount, queueFamilyProperties.data());
